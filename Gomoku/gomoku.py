...
class Gomoku:
    ...
    def play(self):
        ...
        self.board.win = -1
        self.player[0].init_game(self.board, 0)
        self.player[1].init_game(self.board, 1)
        ...
        while result == -1:
            current_player = self.player[self.board.turn]
            opposite_player = self.player[self.board.turn ^ 1]
